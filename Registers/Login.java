...
public class Login extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        registerLabel.setFont(new java.awt.Font("Trebuchet MS", 1, 14)); // NOI18N
        registerLabel.setForeground(new java.awt.Color(204, 0, 51));
...
//        this.setVisible(false);
        ...
        try
        {
            ...
            ResultSet rs = st.executeQuery("select * from userlist where firstname = (" + "'" + username+ "'" + ");");
            
            while(rs.next())
            {
                name = rs.getString("firstname");
                pass = rs.getString("repassword");
            }
